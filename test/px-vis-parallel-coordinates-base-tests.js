...
var px_vis_parallel_coordinates_1;
...
function runBaseTests() {
  px_vis_parallel_coordinates_1 = document.getElementById('px_vis_parallel_coordinates_1');

  suite('Base Automation Tests for px-vis-parallel-coordinates', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-vis-parallel-coordinates fixture is created', function() {
      assert.isTrue(document.getElementById('px_vis_parallel_coordinates_1') !== null);
    });
